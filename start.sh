...
#docker run --name app     -v /root/sites:/var/www/sites -v $(pwd)/app/node_modules:/src/node_modules --link mongo:mongo -e CBDEST=/var/www/app -d node-app
docker run --name app     -v /root/sites:/var/www/sites --link mongo:mongo -e CBDEST=/var/www/app -d node-app
#docker run --name release -v /root/sites:/var/www/sites -v $(pwd)/release/node_modules:/src/node_modules --link mongo:mongo -e CBDEST=/var/www/sites -d node-release
